...
const UsersList = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            setError("Foydalanuvchilarni olishda xatolik: " + err.message);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            ...
            {!loading && users.length > 0 ? (
                        ...
                        <tbody>
                            {users.map((user, idx) => (
                                <tr key={user.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="p-2 border text-center">User</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                !loading && <p className="text-center text-gray-500">Foydalanuvchilar topilmadi.</p>
            )}
        </div>
    );
};
