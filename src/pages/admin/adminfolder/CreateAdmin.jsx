...
function CreateAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError(null);
        try {
            const response = await axios.post('https://165.232.87.222/api/Users/Insert', value);
            const userId = response.data.data.id

            if (response.statusText === 'OK') {
                const resRole = await axios.post('https://165.232.87.222/api/Users/AssignRole/assign-role', {
                    userId: userId,
                    role: 0
                })
