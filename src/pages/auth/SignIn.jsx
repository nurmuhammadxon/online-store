...
function SignIn() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const resToken = await axios.post('https://techstationapi-epe0ggbffchncbbc.canadacentral-01.azurewebsites.net/api/Auth/Post/authenticate',
                {
            ...
            if (resToken.statusText === 'OK') {
                const users = await axios.get('https://techstationapi-epe0ggbffchncbbc.canadacentral-01.azurewebsites.net/api/Users/GetAll')
